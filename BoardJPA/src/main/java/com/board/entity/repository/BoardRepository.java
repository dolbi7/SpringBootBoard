...
import com.board.entity.BoardEntity;
	...
	public Long findPreSeqno(@Param("seqno") Long seqno, @Param("keyword1") String keyword1, @Param("keyword2") String keyword2, @Param("keyword3") String content); 
	...
	public Long findNextSeqno(@Param("seqno") Long seqno, @Param("keyword1") String keyword1, @Param("keyword2") String keyword2, @Param("keyword3") String content);
	
	//게시물 조회수 증가
	@Transactional
	@Modifying //테이블에 반영된 내용이 엔티티 클래스에 적용될 수 있도록 함.
	@Query(value = "update tbl_board set hitno = nvl(hitno, 0) + 1 where seqno = :seqno", nativeQuery = true)

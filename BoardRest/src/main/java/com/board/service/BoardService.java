...
public interface BoardService {
	...
	//게시물 목록 보기
		...
		/*
		 * //게시물 삭제에서 파일 삭제를 위한 파일 목록 가져 오기 public List<BoardEntity>
		 * deleteFileOnBoard(int seqno) throws Exception;
		 * 
		 * //회원 탈퇴 시 회원이 업로드한 파일 정보 가져 오기 public List<BoardEntity>
		 * fileInfoByUserid(String userid) throws Exception;
		 */
